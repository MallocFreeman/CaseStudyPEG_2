...
@LargeTest
public class ProfileOverviewActivityTest {

  @Rule
  public ActivityScenarioRule<ProfileOverviewActivity> activityScenarioRule =
      new ActivityScenarioRule<>(ProfileOverviewActivity.class);
