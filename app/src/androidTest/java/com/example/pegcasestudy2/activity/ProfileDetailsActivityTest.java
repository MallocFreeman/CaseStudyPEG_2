...
public class ProfileDetailsActivityTest {
  ...
  @Rule
  public ActivityScenarioRule<ProfileDetailsActivity> activityScenarioRule = new ActivityScenarioRule<>(
      createIntent());
  ...
  private static Intent createIntent() {
    ...
    intent.putExtra(ProfileParcel.PARCELABLE_NAME, new ProfileParcel(createTestProfile()));
    return intent;
  }
